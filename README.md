...
🚄 垂直于铁路出行领域的 **AI Agent + Web 全栈** 原型：FastAPI 后端、Next.js 前端、对话式查票/规划、结构化卡片、演示票务与检票闭环。

### 文档（比赛/答辩推荐从这里读）

| 路径 | 说明 |
|------|------|
| **`docx/00_答辩与演示导读.md`** | **一页导读**：评委叙事、三分钟脚本、金句、近期硬亮点 |
| `docx/01_技术架构文档.md` | 架构、Agent、合规、近期工程深化 |
| `docx/02_功能规格说明书_用户故事.md` | 功能、场景、验收与用例 |
| `docx/03_UI_UX设计文档.md` | CUI/GUI 原则与关键交互 |
| `docx/04_市场分析_商业化方案.md` | 市场、竞品、商业化 |
| `docx/05_测试报告_用户反馈.md` | 测试用例与反馈 |
| `docx/06_团队介绍.md` | 团队分工 |

详细前端架构见 `FRONTEND_ARCHITECTURE.md`。
