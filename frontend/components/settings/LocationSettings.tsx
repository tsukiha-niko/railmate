  ...
  return (
    <Card variant="outlined">
      <CardContent sx={{ display: "flex", flexDirection: "column", gap: 2, p: { xs: 2, sm: 2.5 } }}>
        ...
        {location ? (
          <Box sx={{ display: "flex", alignItems: "flex-start", gap: 1.5, borderRadius: "0 10px 10px 0", borderLeft: 3, borderLeftColor: "primary.main", bgcolor: "action.hover", p: 2 }}>
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5, borderRadius: "10px", border: 1, borderColor: (th: any) => `${th.palette.divider}70`, bgcolor: "background.paper", p: 2 }}>
