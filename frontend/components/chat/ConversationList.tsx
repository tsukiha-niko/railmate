    ...
    <Box sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <Box sx={{ borderBottom: 1, borderColor: "divider", px: 2, py: 1.5 }}>
        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 1.25, px: 0.25 }}>
          ...
          <Chip label={conversations.length} size="small" variant="outlined" sx={{ borderRadius: 999, height: 22 }} />
        </Box>
        <Button
          variant="outlined"
          size="small"
          ...
          sx={{ justifyContent: "flex-start", borderRadius: 3, borderColor: (th) => `${th.palette.divider}90` }}
        >
